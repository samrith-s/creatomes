...
function initHowto(data, theme, easing, contentInEffect, contentOutEffect, showTime) {
    ...
    arrowImg="assets/js/modules/howto/img/arrow.png";
    initHowtoTheme();
...
function loadHowtoTheme() {
    ...
    switch(htTheme) {
        case "light":
            $("#howtoContent").css({background: "rgba(235, 235, 235, 1)"});
            $("#howtoContent").addClass('howto-blackbox');
            break;

        case "dark":
            $("#howtoContent").css({background: "rgba(35, 35, 35, 1)"});
            $("#howtoContent").addClass('howto-whitebox');
            break;
